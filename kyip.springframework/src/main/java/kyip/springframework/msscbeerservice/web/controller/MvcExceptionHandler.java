...
//Controller advice will implement its methods globally.
//This is to reduce repeated codes on the controller classes
//Any controller method that is using @Validated will route its exception to here
@ControllerAdvice
